...
class pgm40
{
	public static void main(String args[])
	{
		...
		System.out.println("Removing Elements");	
  		...
  		hm4.put(new Integer(1), "Anagha");
        	hm4.put(new Integer(2), "Sarang");
        	hm4.put(new Integer(3), "Swomya");
        	hm4.put(new Integer(4), "Amalendu");
...
Removing Elements
{1=Anagha, 2=Sarang, 3=Swomya, 4=Amalendu}
{1=Anagha, 2=Sarang, 3=Swomya}